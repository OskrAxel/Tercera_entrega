...
<head>
    ...
    <title>Evaluación Becarios</title>
</head>
<style type="text/css">
...
<body>
    ...
    <div id="header">
        ...
        <table>
            ...
            <tr>
                <td style="text-align: center;">TIPO DE REPORTE:&nbsp;&nbsp;Evaluación Becario</td>
            </tr>
            <tr>
            ...
            <?php
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $row_set["nombre"]." ".$row_set["apellido"] ?></td>
                        <td><?php echo $row_set["email"] ?></td>
                        <td><?php echo $row_set["celular"] ?></td>
                        <td><?php echo $row_set["not_sist"] ?></td>
                        <td><?php echo $row_set["nota_eva"] ?></td>
                        <td><?php echo $row_set["not_fin"] ?></td>
                    </tr>
                <?php }
                ?>
            </tbody>
