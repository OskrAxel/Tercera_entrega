...
function Horarios6() {
  ...
  const peticionGet = async () => {
    await axios
      .get(`https://bqef-bo.com/api/bec/horario6.php`, {
        params: {
  ...
  const peticionPut = async () => {
    ...
    f.append("METHOD", "PUT");
    await axios
      .post(`https://bqef-bo.com/api/bec/horario6.php`, f, {
    ...
    <div id="main_content">
      <div className="tra">
        ...
        <Pagination
          ...
          <PaginationItem>
            <PaginationLink href="/horarios5" previous />
          </PaginationItem>
          <PaginationItem>
          ...
          <PaginationItem>
            <PaginationLink href="/horarios7" next />
          </PaginationItem>
          <PaginationItem>
