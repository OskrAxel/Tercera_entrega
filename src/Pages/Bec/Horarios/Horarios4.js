...
function Horarios4() {
  ...
  const peticionGet = async () => {
    await axios
      .get(`https://bqef-bo.com/api/bec/horario4.php`, {
        params: {
  ...
  const peticionPut = async () => {
    ...
    f.append("METHOD", "PUT");
    await axios
      .post(`https://bqef-bo.com/api/bec/horario4.php`, f, {
    ...
    <div id="main_content">
      <div className="tra">
        ...
        <Pagination
          ...
          <PaginationItem>
            <PaginationLink href="/horarios3" previous />
          </PaginationItem>
          <PaginationItem>
          ...
          <PaginationItem>
            <PaginationLink href="/horarios5" next />
          </PaginationItem>
          <PaginationItem>
