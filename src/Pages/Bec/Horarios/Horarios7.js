...
function Horarios7() {
  ...
  const peticionGet = async () => {
    await axios
      .get(`https://bqef-bo.com/api/bec/horario7.php`, {
        params: {
  ...
  const peticionPut = async () => {
    ...
    f.append("METHOD", "PUT");
    await axios
      .post(`https://bqef-bo.com/api/bec/horario7.php`, f, {
    ...
    <div id="main_content">
      <div className="tra">
        ...
        <Pagination
          ...
          <PaginationItem>
            <PaginationLink href="/horarios6" previous />
          </PaginationItem>
          <PaginationItem>
          ...
          <PaginationItem>
            <PaginationLink href="/horarios8" next />
          </PaginationItem>
          <PaginationItem>
