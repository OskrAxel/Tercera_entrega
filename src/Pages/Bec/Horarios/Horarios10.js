...
function Horarios10() {
  ...
  const peticionGet = async () => {
    await axios
      .get(`https://bqef-bo.com/api/bec/horario10.php`, {
        params: {
  ...
  const peticionPut = async () => {
    ...
    f.append("METHOD", "PUT");
    await axios
      .post(`https://bqef-bo.com/api/bec/horario10.php`, f, {
    ...
    <div id="main_content">
      <div className="tra">
        ...
        <Pagination
          ...
          <PaginationItem>
            <PaginationLink href="/horarios9" previous />
          </PaginationItem>
          <PaginationItem>
