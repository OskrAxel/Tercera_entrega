...
function Nota2() {
  ...
  const peticionGet = async () => {
    await axios
      .get(`http://localhost:80/api/bec/nota2.php`, {
        params: {
  ...
  const peticionPut = async () => {
    ...
    f.append("METHOD", "PUT");
    await axios
      .post(`http://localhost:80/api/bec/nota2.php`, f, {
        ...
        <Form id="tab_not">
          <UncontrolledDropdown direction="down">
            ...
            <DropdownMenu className="drop-menu">
              <DropdownItem href="./notas1">Primer Semestre</DropdownItem>
              <DropdownItem disabled href="./nota2">
                Segundo Semestre
              </DropdownItem>
              ...
              <DropdownItem href="./nota9">Noveno Semestre</DropdownItem>
